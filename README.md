...
- The views support full and partial <a href="4_filtered-view-grouped-by-country-company-manager-andreas-user-card.png" target="_blank">search</> by user's name.
