...
- The views support full and partial <a href="samples/images/4_filtered-view-grouped-by-country-company-manager-andreas-user-card.png" target="_blank" data-interception="off">search</a> by user's name.
